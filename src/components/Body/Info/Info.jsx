  ...
  return (
    <article>
      <div className={cl.info__wrapper}>
        ...
        <div>
          <iframe className={cl.info__map} src="https://yandex.ru/map-widget/v1/?um=constructor%3A31208e706cc29fb7b153402c0ad32b4eef7df3b428c214db7c3a250f6601abc4&amp;source=constructor" frameBorder="0"></iframe>
        </div>
