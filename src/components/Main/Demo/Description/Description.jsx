    ...
    return (
        <div className={reverse ? cl.description + ' ' + cl.description_reverse : cl.description}>
            ...
            <div className={cl.description__item + ' ' + cl.description__text}>
                ...
                {
                    availability ?
                        <div className={cl.description_400 + ' ' + cl.description_blue}>Товары под заказ в наличии: {availability} шт.</div> :
                        <div></div>
                }
                {
                    price ?
                        <div className={cl.description_400}>Цены от: {price} руб.</div> :
                        <div></div>
                }
