...
export default function FooterNav() {
    const footerNavHorizontal = useSelector(
        (state) => state.information.footerNavHorizontal
    );
    const footerNavAside = useSelector(
        (state) => state.information.footerNavAside
    );
